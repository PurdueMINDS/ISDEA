...
if __name__ == "__main__":
    ...
    (title, focus) = params.dataset.split("-")  # MODIFY
    is_trans = focus == "trans"  # MODIFY
    assert is_trans  # MODIFY
    ...
    if title in ["FD1", "FD2"]:  # MODIFY
        ...
        params.file_paths = {  # MODIFY
            "train0": os.path.join(  # MODIFY
                params.main_dir,
                "data/{}/{}.txt".format(params.dataset, "observe"),  # MODIFY
            ),  # MODIFY
            "train1": os.path.join(  # MODIFY
                params.main_dir,
                "data/{}/{}.txt".format(params.dataset, "train"),  # MODIFY
            ),  # MODIFY
            "valid": os.path.join(  # MODIFY
                params.main_dir,
                "data/{}/{}.txt".format(params.dataset, "valid"),  # MODIFY
            ),  # MODIFY
        }  # MODIFY
    else:  # MODIFY
        # # MODIFY
        params.file_paths = {  # MODIFY
            "train": os.path.join(  # MODIFY
                params.main_dir,
                "data/{}/{}.txt".format(params.dataset, "train"),  # MODIFY
            ),  # MODIFY
            "valid": os.path.join(  # MODIFY
